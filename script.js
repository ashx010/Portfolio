...
var projects = {
    "webdev": {
        "project1": {
            "title": "Portfolio",
            "sub-title": "",
            "image": "images/portfolioprojectimg.jpg",
            "links": {
                "github": "",
        ...
        "project2": {
            ...
            "image": "images/mappingprojectimg.jpg",
            "links": {
                "github": "",
    ...
    "datascience": {
        ...
        "project3": {
            ...
            "sub-title": "",
            "image": "images/digitrecognizer.jpg",
            "links": {
...
function addprojectcards(project_category, projects_cards, project_code_link, category = 'webdev') {
    ...
    $('.projects-info .project-links a img').eq(0).attr('src', 'images/' + project_code_link + '.png');
...
var skills = {
    'webdev': {
        ...
        'skills': {
            'self': 'images/webdevskillscover.jpg',
            'HTML': 'images/icons8-html-96.png',
            'CSS': 'images/icons8-css-96.png',
            'JavaScript': 'images/icons8-js-96.png',
            'Python': 'images/icons8-python-96.png',
            'PHP': 'images/icons8-php-96.png',
    ...
    'datascience': {
        'name': 'Data Science',
        'skills': {
            'self': 'images/datascienceskillscover.jpg',
            'Python': 'images/icons8-python-96.png',
            'Pandas': 'images/pandas.png',
            'Machine Learning': 'images/machine-learning.png',
            'Data Analysis': 'images/data-analysis.png',
            'Data Visualization': 'images/data-visual.png',
            'NLP': 'images/nlp.png',
            ...
            var add_exp_edu_plate = `
                <div expedu_number="${i}" class="expedu-row">
                    ...
                    <div class="expedu-circle">
                        <div class="circle-img" style="${category === 'exp' ? "background: url('images/experience.png'); background-size: cover; background-position: center;" : "background: url('images/education.png'); background-size: cover; background-position: center;"}"></div>
                    </div>
                </div>`;
